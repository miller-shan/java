...
public class MyExtentReporterListener implements IReporter {
    //生成的路径以及文件名
    private static final String OUTPUT_FOLDER = "reports/test-output/";
...
//        }
    ...
    private void init() {
        ...
        htmlReporter.config().setDocumentTitle("API Autotest reports");
        htmlReporter.config().setReportName("API Autotest reports");
